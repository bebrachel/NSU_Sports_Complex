...
class AuthControllerTest {
    ...
    // Use-case: Нельзя получить список пользователей без доступа.
    @Test
    void testUnauthorized() throws Exception {
        // When: Выполняем GET-запрос на получение списка пользователей.
        mockMvc.perform(get("/api/users"))

                // Then: Проверяем, что ответ имеет статус 403
